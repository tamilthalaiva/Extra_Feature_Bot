...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🤖 Updates', url='https://t.me/sblovers2')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🆘 𝐒𝐔𝐔𝐏𝐎𝐑𝐓', url='https://t.me/sblovers2'),
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('⭕☞𝗠𝗔𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟⭕', url="https://t.me/Tamilthalaiva3")
                ],
                [
                    InlineKeyboardButton('⭕☞𝗠𝗢𝗩𝗜𝗘𝗦 𝗚𝗥𝗢𝗨𝗣⭕', url="https://t.me/sbmovietamzha")
                ],
                [
...
async def msg_handler(c, m):
    await m.reply_text(
        "𝐇𝐞𝐥𝐥𝐨 𝐮𝐬𝐞𝐫𝐬 👋 \𝐧𝐘𝐨𝐮 𝐚𝐫𝐞 𝐧𝐨𝐭 𝐚𝐥𝐥𝐨𝐰𝐞𝐝 𝐭𝐨 𝐮𝐬𝐞 𝐦𝐞 𝐈𝐧 𝐏𝐌 𝐓𝐨 𝐚𝐯𝐨𝐢𝐝 𝐮𝐧𝐰𝐚𝐧𝐭𝐞𝐝 𝐟𝐥𝐨𝐨𝐝𝐬 𝐚𝐧𝐝 𝐜𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭 𝐢𝐬𝐬𝐮𝐞\n𝐇𝐨𝐰𝐞𝐯𝐞𝐫 𝐘𝐨𝐮 𝐜𝐚𝐧 𝐆𝐞𝐭 𝐲𝐨𝐮𝐫 𝐫𝐞𝐪𝐮𝐢𝐫𝐞𝐝 𝐦𝐨𝐯𝐢𝐞𝐬 𝐡𝐞𝐫𝐞 👉@sbmovietamzha\n𝐈𝐟 𝐲𝐨𝐮 𝐧𝐞𝐞𝐝 𝐭𝐨 𝐜𝐡𝐢𝐭 𝐜𝐡𝐚𝐭 𝐨𝐫 𝐫𝐞𝐩𝐨𝐫𝐭 𝐚𝐧𝐲 𝐛𝐮𝐠𝐬 𝐲𝐨𝐮 𝐚𝐫𝐞 𝐟𝐫𝐞𝐞 𝐭𝐨 𝐜𝐡𝐚𝐭 𝐡𝐞𝐫𝐞 👉@tamilthalaiva4\n\n𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐘𝐨𝐮𝐫 𝐂𝐨𝐨𝐩𝐞𝐫𝐚𝐭𝐢𝐨𝐧✨\n\n♥️ 𝗧𝗲𝗮𝗺 ➜ @Tamilthalaiva3"
    )
